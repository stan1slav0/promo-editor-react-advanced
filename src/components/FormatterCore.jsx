...
export default function FormatterCore({
  ...
  const activeCategoryIndex = Math.max(
    0,
    availableCategories.findIndex((category) => category.toLowerCase() === activeCategory?.toLowerCase())
  )
        ...
        <div className="main-input-number-block">
          ...
          >
            <button
              ...
              onClick={() => {
                setMode('basic')
                toast.info('Basic Mode', { autoClose: 1500, hideProgressBar: true, closeButton: false })
              }}
            >
              <span>Basic</span>
            </button>
            ...
            <button
              ...
              onClick={() => {
                setMode('advanced')
                toast.info('Custom Mode', { autoClose: 1500, hideProgressBar: true, closeButton: false })
              }}
            >
              <span>Custom</span>
            </button>
            ...
            >
              {availableCategories.map((cat) => (
                <button
                  ...
                  aria-pressed={activeCategory === cat.toLowerCase()}
